...
formEl.addEventListener("submit", (e) => {
  ...
  //Delete invalid class
    let invalidEl = document.querySelector(".comment-section__input--invalid");
    if (invalidEl){
        invalidEl.classList.remove('comment-section__input--invalid');}

//     if (invalidEls){
//      invalidEls.forEach((element) => {element.classList.remove('comment-section__input--invalid')});
//  }
